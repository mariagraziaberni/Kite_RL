...
class Agent: 
    ...
    def __init__(self, input_dims, n_actions, critic_lr=0.0005, actor_lr = 0.0005, tau = 0.005, gamma = 0.99, update_actor_interval =2, warmup = 50000, 
        ...
        self.actor_optimizer = RAdam(self.actor.parameters(),lr = actor_lr) 
        
        self.critic_1_optimizer = RAdam(self.critic_1.parameters(),lr = critic_lr) 
        
        self.critic_2_optimizer = RAdam(self.critic_2.parameters(),lr = critic_lr) 
    ...
    def train(self,combined=False,clip=False): 
        ...
        actor_loss = -torch.mean(actor_q1_loss) #prendere pesi dell'attore qui
